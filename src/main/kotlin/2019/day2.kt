...
fun main() {
    val nums = File("src/main/kotlin/inputs/2019/day2.txt")
        .readText()
    val part1 = Day02(nums).solvePart1(noun = 12, verb = 2)
    println(part1)
    val part2 = Day02(nums).solvePart2()
    println(part2)
...
class Day02(input: String) {
    ...
    fun solvePart2(target: Int = 19690720): Int {
        (0..99).forEach { noun ->
            (0..99).forEach { verb ->
